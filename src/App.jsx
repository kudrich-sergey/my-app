...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://6398c45429930e2bb3c17961.mockapi.io/tyrs')
            const cartData = await axios.get('https://6398c45429930e2bb3c17961.mockapi.io/cart')
            const favoritesData = await axios.get('https://6398c45429930e2bb3c17961.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://6398c45429930e2bb3c17961.mockapi.io/cart/${id}`)
